...
namespace Day07
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Sting does {sting.DoDamage(5)}");
            backpack.AddItem(sting);

            string bar = new string(' ', 15);//string's overload
